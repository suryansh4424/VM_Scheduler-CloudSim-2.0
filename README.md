...
## **4. Results:**
The [CPU usage analysis](https://github.com/suryansh4424/VM_Scheduler-CloudSim-2.0/tree/main/Phase1/02_Analysis) revealed that the peak CPU usage occurred at Hour X, with an average CPU utilization of Y%.
